...
console.COMMANDS = {
  ...
  loadtestbig = function()
    leveldelete()
    leveldata = love.image.newImageData("testbig.png")
    levelgen()
  end,
  loadtestsmall = function()
    leveldelete()
...
console.COMMAND_HELP = {
  ...
  debugmap = "load the test map of the game",
  loadtestbig = "load the massive grid test map",
  loadtestsmall =  "load the small grid test map"
}
